...
<div class="sidebar-custom" id="sidebar-wrapper">
    ...
    <div class="list-group list-group-flush">
        <a href="<?php echo BASE_URL; ?>/parent/dashboard.php" class="list-group-item list-group-item-action <?php echo ($current_page == 'dashboard.php') ? 'active' : ''; ?>">
            <i class="fas fa-tachometer-alt me-2"></i>Dashboard
        </a>
        <a href="<?php echo BASE_URL; ?>/parent/my_children.php" class="list-group-item list-group-item-action <?php echo in_array($current_page, ['my_children.php', 'view_child_profile.php', 'view_results.php']) ? 'active' : ''; ?>">
