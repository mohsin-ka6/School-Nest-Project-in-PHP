...
// Fetch current settings for SMS Gateway
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($settings['sms_gateway_host']) || empty($settings['sms_gateway_token'])) {
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form action="" method="POST">
                ...
                <button type="submit" class="btn btn-primary" <?php if (empty($settings['sms_gateway_host'])) echo 'disabled'; ?>>Send to Class</button>
            </form>
        </div>
    </div>
</div>
