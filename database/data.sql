...
ALTER TABLE `subjects` ADD PRIMARY KEY (`id`), ADD KEY `branch_id` (`branch_id`);
ALTER TABLE `class_subjects` ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `unique_class_subject` (`class_id`,`subject_id`), ADD KEY `branch_id` (`branch_id`), ADD KEY `subject_id` (`subject_id`);
ALTER TABLE `teachers` ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `user_id` (`user_id`), ADD KEY `branch_id` (`branch_id`), ADD KEY `incharge_class_id` (`incharge_class_id`), ADD KEY `incharge_section_id` (`incharge_section_id`);
ALTER TABLE `class_routine` ADD PRIMARY KEY (`id`), ADD KEY `branch_id` (`branch_id`), ADD KEY `class_id` (`class_id`), ADD KEY `section_id` (`section_id`), ADD KEY `subject_id` (`subject_id`), ADD KEY `teacher_id` (`teacher_id`);
...
ALTER TABLE `class_subjects` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
ALTER TABLE `teachers` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
ALTER TABLE `class_routine` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
